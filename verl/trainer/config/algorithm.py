...
class AlgoConfig(BaseConfig):
    ...
    # Prompt-GDRO (Problem 1: Pure Class-Based) settings
    gdro_enable: bool = False
    gdro_eta_q: float = 0.1
    gdro_gamma: float = 0.15
    gdro_prompt_classifier: str = "gsm8k"  # one of: "gsm8k", "math", "custom"
    gdro_max_class_weight: float = 10.0
    # Approach 1.1: choose weighting unit: "class" (default) or "prompt"
    gdro_weight_mode: str = "class"
